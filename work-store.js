...
(function () {
  ...
  const DEFAULT_PROJECTS = [
    ...
    },
    {
      ...
      title: "Nate McMillan",
      titleSub: "Foundation",
      meta: "Nonprofit website · Raleigh, NC",
      tag: "Web design",
      caseStudy: {
        eyebrow: "Case study: Web design",
        sub: "A mentorship-focused nonprofit website for the Nate McMillan Foundation, built to recruit donors, volunteers, and families.",
        facts: [
          { label: "Role", value: "Lead Designer & Front-end" },
          { label: "Team", value: "Independent, with foundation stakeholders" },
          { label: "Tools", value: "HTML, CSS, JS, Netlify" },
          { label: "Type", value: "Website · homepage, about, programs, get involved" },
        ],
        overview:
          "I designed and built the Nate McMillan Foundation website for a Raleigh nonprofit mentoring young men affected by fatherlessness. The site needed to carry a serious mission without feeling cold: full-bleed photography, a warm burgundy and gold system, and clear paths to donate, volunteer, and explore programs. I structured pages around Home, About, Programs, and Get Involved, with camp and year-round offerings front and center. Live demo: https://nmf-demo2.netlify.app/",
        outcome:
          "The foundation went from a thin online presence to a brand-led site that explains the mission in one viewport and makes involvement obvious. Heroes lead with photography and a single promise, program pages spell out camp and community work, and Get Involved turns interest into action. The result is a production-ready nonprofit site the team can share with donors, partners, and families.",
      },
      items: [
        {
          category: "Digital",
          src: "assets/work/nmf-home.png",
          webp: "assets/work/nmf-home.webp",
          alt: "Nate McMillan Foundation homepage with Mentoring at its Finest hero",
          width: 1536,
          height: 1024,
          title: "Homepage",
          span: "Web • brand",
        ...
        {
          category: "Digital",
          src: "assets/work/nmf-about.png",
          webp: "assets/work/nmf-about.webp",
          alt: "Nate McMillan Foundation about page with mission and story",
          width: 1536,
          height: 1024,
          title: "About",
          span: "Web • story",
        ...
        {
          category: "Digital",
          src: "assets/work/nmf-programs.png",
          webp: "assets/work/nmf-programs.webp",
          alt: "Nate McMillan Foundation programs page highlighting mentoring camp",
          width: 1536,
          height: 1024,
          title: "Programs",
          span: "Web • IA",
        ...
        {
          category: "Digital",
          src: "assets/work/nmf-get-involved.png",
          webp: "assets/work/nmf-get-involved.webp",
          alt: "Nate McMillan Foundation get involved page with volunteer call to action",
          width: 1536,
          height: 1024,
          title: "Get Involved",
          span: "Web • conversion",
